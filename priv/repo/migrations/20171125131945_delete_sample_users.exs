defmodule Advisor.Repo.Migrations.DeleteSampleUsers do
  ...
  def down do
    ...
    Repo.insert!(%Person{name: "Enrique Comba Riepenhausen" , email: "ecomba@example.com", is_group_lead: true})
    ...
    Repo.insert!(%Person{name: "Georgina McFadyen"          , email: "georgina@example.com", is_group_lead: true})
  end
end
